...
static  uint32_t CycleCounter = 0;
 ...
 //typedef for pattern generation function pointer
...
//static ptrnFunc ListeningPattern2 = SingleFocusPulse;
...
uint16_t * UpdatePattern(void){    
    ...
    switch(*PatternID){
        ...
        case WELCOME_PATTERN:
            ...
            WelcomePattern(PixelPattern, &PatternStepCounter, &CycleCounter, WELCOME_HUE, WELCOME_SAT, 0);
        break;
        
        case IDLE_PATTERN:
            IdlePattern(PixelPattern, &PatternStepCounter, &CycleCounter, IDLE_HUE, IDLE_SAT, 0);
        break;
        
        case THINKING_PATTERN:
            ThinkingPattern(PixelPattern, &PatternStepCounter, &CycleCounter, THINKING_HUE, THINKING_SAT, 0);
        break;
        
        case SPEAKING_PATTERN:
            SpeakingPattern(PixelPattern, &PatternStepCounter, &CycleCounter, SPEAKING_HUE, SPEAKING_SAT, ListeningFocus);  
        break;
        
        case LISTENING_PATTERN:
            ListeningPattern(PixelPattern, &PatternStepCounter, &CycleCounter, LISTENING_HUE, LISTENING_SAT, ListeningFocus);
        break;
        
        #ifdef PATTERN_TEST_ENABLE
        case TEST_PATTERN:
            TestPattern(PixelPattern, &PatternStepCounter, &CycleCounter, TEST_HUE, TEST_SAT, 0);
        break;
        #endif
